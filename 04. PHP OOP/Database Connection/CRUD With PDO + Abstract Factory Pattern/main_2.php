	...
	?>
			<tr>
				...
				<td>
				    ...
				    <?php echo "<a href='main_2.php?action=update&id=".$val['id']."'>Edit</a>";?> ||
					<?php echo "<a href='main_2.php?action=delete&id=".$val['id']."' onClick='return confirm(\"Are you sure to Delete data...\")'>Delete</a>";?>
				</td>
			</tr>
<?php }?>
